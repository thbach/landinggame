...
stage.canvas.width = viewportwidth;
stage.canvas.height = viewportheight;
...
function handleComplete() {
    ...
    ground.graphics.beginBitmapFill(groundImg).drawRect(0, 0, w+groundImg.width, groundImg.height/2);
    ground.tileW = groundImg.width;
    ground.y = h-groundImg.height/2;
    ...
    bird.setTransform(startX, startY, 0.5, 0.5);
    // Set framerate
    bird.framerate = 30;
    ...
    createjs.Tween.get(bird, {loop:true}).to({y:startY + wiggleDelta}, 380, createjs.Ease.sineInOut).to({y:startY}, 380, createjs.Ease.sineInOut);
            ...
            logo = new createjs.Text(0, "83px 'Flappy Bird'", "#ffffff");
    ...
    //stage.addEventListener("stagemousedown", handleJumpStart);
            ...
            counter = new createjs.Text(0, "48px 'Flappy Bird'", "#ffffff");
            counterOutline = new createjs.Text(0, "48px 'Flappy Bird'", "#000000");
            counterOutline.outline = 1
            counterOutline.textAlign = 'center'
            counter.textAlign = 'center'
            counterOutline.x = w/2
            counterOutline.y = h/10
            counter.x = w/2
            counter.y = h/10
            counter.alpha = 0
